                ...
                <form method="POST" action="">
                    ...
                    <div class="modal-body">
                        ...
                        <h2>Crear Nueva Sucursal</h2>                           
                            ...
                            <div class="form-group">
                                <label for="dirección" class="form-label">Comuna</label>
                                <input type="text" class="form-control input-md" name="comuna" id="comuna" required="">                  
                            </div>

                            <div class="form-group">
                                <label for="dirección" class="form-label">Dirección</label>
                                <input type="text" class="form-control input-md" name="direccion" id="direccion" required="">                  
                            </div>
                        </div>
                    </div>
